import pygame, cv2, random, os, subprocess, sys
...
class Tile(pygame.sprite.Sprite):
    def __init__(self, filename, x, y):
        ...
        self.original_image = pygame.image.load('images/mercurio/' + filename)

        self.back_image = pygame.image.load('images/mercurio/' + filename)
...
class Game():
    def __init__(self):
        ...
        # aliens
        self.all_aliens = [f for f in os.listdir('images/mercurio') if os.path.join('images/aliens', f)]
        ...
        self.button_image = pygame.image.load('images/inicio.png').convert_alpha()
        self.button_rect = self.button_image.get_rect(topleft=(10, 10))
    ...
    def draw(self):
        ...
        # text
        title_text = title_font.render('Planeta Mercurio', True, WHITE)
        ...
        info_text = content_font.render('Encuentra las 2 imagenes iguales', True, WHITE)
        ...
        if not self.level == 5:
            next_text = content_font.render('Nivel completado. Presiona la barra espaciadora para el siguiente nivel', True, WHITE)
        else:
            next_text = content_font.render('Felicitaciones. Ganaste. Presiona la barra espaciadora para volver a jugar', True, WHITE)
    ...
    def get_video(self):
        self.cap = cv2.VideoCapture('video/mercurio.mp4')
        self.success, self.img = self.cap.read()
