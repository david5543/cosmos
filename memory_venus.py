...
class Tile(pygame.sprite.Sprite):
    def __init__(self, filename, x, y):
        ...
        self.original_image = pygame.image.load('images/venus/' + filename)

        self.back_image = pygame.image.load('images/venus/' + filename)
...
class Game():
    def __init__(self):
        ...
        # aliens
        self.all_aliens = [f for f in os.listdir('images/venus') if os.path.join('images/venus', f)]
    ...
    def get_video(self):
        self.cap = cv2.VideoCapture('video/venus.mp4')
        self.success, self.img = self.cap.read()
