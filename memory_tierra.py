...
class Tile(pygame.sprite.Sprite):
    def __init__(self, filename, x, y):
        ...
        self.original_image = pygame.image.load('images/tierra/' + filename)

        self.back_image = pygame.image.load('images/tierra/' + filename)
...
class Game():
    def __init__(self):
        ...
        # aliens
        self.all_aliens = [f for f in os.listdir('images/tierra') if os.path.join('images/aliens', f)]
    ...
    def draw(self):
        ...
        # text
        title_text = title_font.render('Planeta Tierra', True, WHITE)
